...
public:
    ...
    //*************  
    void ExtractORB_depth(int flag, const cv::Mat &im, const int x0, const int x1,const cv::Mat &dm);
...
public:
    ...
    vector<cv::Rect2i> mvDynamicArea0;
    vector<cv::Rect2i> mvDynamicArea1;    
