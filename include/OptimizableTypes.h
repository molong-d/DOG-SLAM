...
#ifndef DOG_SLAM3_OPTIMIZABLETYPES_H
#define DOG_SLAM3_OPTIMIZABLETYPES_H
...
class EdgeSim3ProjectXYZ : public  g2o::BaseBinaryEdge<2, Eigen::Vector2d, g2o::VertexSBAPointXYZ, DOG_SLAM3::VertexSim3Expmap>
{
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    EdgeSim3ProjectXYZ();
    ...
    void computeError()
    {
        const DOG_SLAM3::VertexSim3Expmap* v1 = static_cast<const DOG_SLAM3::VertexSim3Expmap*>(_vertices[1]);
        const g2o::VertexSBAPointXYZ* v2 = static_cast<const g2o::VertexSBAPointXYZ*>(_vertices[0]);
...
#endif //DOG_SLAM3_OPTIMIZABLETYPES_H
