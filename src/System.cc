    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    cout << endl <<
    "DOG-SLAM Copyright (C) 2017-2020 Carlos Campos, Richard Elvira, Juan J. Gómez, José M.M. Montiel and Juan D. Tardós, University of Zaragoza." << endl <<
    ...
    mptLocalMapping = new thread(&DOG_SLAM3::LocalMapping::Run,mpLocalMapper);
    ...
    mptLoopClosing = new thread(&DOG_SLAM3::LoopClosing::Run, mpLoopCloser);
...
void System::SaveTrajectoryTUM(const string &filename)
{
    ...
    list<DOG_SLAM3::KeyFrame*>::iterator lRit = mpTracker->mlpReferences.begin();
