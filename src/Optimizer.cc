                                 ...
                                 int nIterations, bool* pbStopFlag, const unsigned long nLoopKF, const bool bRobust)
{
    ...
    vector<DOG_SLAM3::EdgeSE3ProjectXYZ*> vpEdgesMono;
    vpEdgesMono.reserve(nExpectedSize);

    vector<DOG_SLAM3::EdgeSE3ProjectXYZToBody*> vpEdgesBody;
       ...
       const map<KeyFrame*,tuple<int,int>> observations = pMP->GetObservations();
        ...
        for(map<KeyFrame*,tuple<int,int>>::const_iterator mit=observations.begin(); mit!=observations.end(); mit++)
        {
            ...
            if(leftIndex != -1 && pKF->mvuRight[get<0>(mit->second)]<0)
            {
                ...
                DOG_SLAM3::EdgeSE3ProjectXYZ* e = new DOG_SLAM3::EdgeSE3ProjectXYZ();
            ...
            if(pKF->mpCamera2){
                ...
                if(rightIndex != -1 && rightIndex < pKF->mvKeysRight.size()){
                    ...
                    DOG_SLAM3::EdgeSE3ProjectXYZToBody *e = new DOG_SLAM3::EdgeSE3ProjectXYZToBody();
    ...
    for(size_t i=0; i<vpKFs.size(); i++)
    {
        ...
        else
        {
            ...
            if(dist > 1)
            {
                ...
                {
                    DOG_SLAM3::EdgeSE3ProjectXYZ* e = vpEdgesMono[i2];
...
int Optimizer::PoseOptimization(Frame *pFrame)
{
    ...
    vector<DOG_SLAM3::EdgeSE3ProjectXYZOnlyPose*> vpEdgesMono;
    vector<DOG_SLAM3::EdgeSE3ProjectXYZOnlyPoseToBody *> vpEdgesMono_FHR;
        ...
        if(pMP)
        {
            ...
            if(!pFrame->mpCamera2){
                ...
                if(pFrame->mvuRight[i]<0)
                {
                    ...
                    DOG_SLAM3::EdgeSE3ProjectXYZOnlyPose* e = new DOG_SLAM3::EdgeSE3ProjectXYZOnlyPose();
            ...
            //SLAM with respect a rigid body
                ...
                if (i < pFrame->Nleft) {    //Left camera observation
                    ...
                    DOG_SLAM3::EdgeSE3ProjectXYZOnlyPoseToBody *e = new DOG_SLAM3::EdgeSE3ProjectXYZOnlyPoseToBody();
    ...
    for(size_t it=0; it<4; it++)
    {
        ...
        {
            DOG_SLAM3::EdgeSE3ProjectXYZOnlyPose* e = vpEdgesMono[i];
        ...
        {
            DOG_SLAM3::EdgeSE3ProjectXYZOnlyPoseToBody* e = vpEdgesMono_FHR[i];
...
void Optimizer::LocalBundleAdjustment(KeyFrame *pKF, bool* pbStopFlag, Map* pMap, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges)
{
    ...
    for(size_t i=0, iend=vpEdgesMono.size(); i<iend;i++)
    {
        DOG_SLAM3::EdgeSE3ProjectXYZ* e = vpEdgesMono[i];
    ...
    {
        DOG_SLAM3::EdgeSE3ProjectXYZToBody* e = vpEdgesBody[i];
                            ...
                            const bool bFixScale, Eigen::Matrix<double,7,7> &mAcumHessian, const bool bAllPoints)
{
    ...
    // Set Sim3 vertex
    DOG_SLAM3::VertexSim3Expmap * vSim3 = new DOG_SLAM3::VertexSim3Expmap();
    vSim3->_fix_scale=bFixScale;
    ...
    vector<DOG_SLAM3::EdgeSim3ProjectXYZ*> vpEdges12;
    vector<DOG_SLAM3::EdgeInverseSim3ProjectXYZ*> vpEdges21;
    ...
    for(int i=0; i<N; i++)
    {
        ...
        DOG_SLAM3::EdgeSim3ProjectXYZ* e12 = new DOG_SLAM3::EdgeSim3ProjectXYZ();
        ...
        DOG_SLAM3::EdgeInverseSim3ProjectXYZ* e21 = new DOG_SLAM3::EdgeInverseSim3ProjectXYZ();
    ...
    {
        DOG_SLAM3::EdgeSim3ProjectXYZ* e12 = vpEdges12[i];
        DOG_SLAM3::EdgeInverseSim3ProjectXYZ* e21 = vpEdges21[i];
        if(!e12 || !e21)
            continue;
        ...
        if(e12->chi2()>th2 || e21->chi2()>th2)
        {
            ...
            vpEdges12[i]=static_cast<DOG_SLAM3::EdgeSim3ProjectXYZ*>(NULL);
            vpEdges21[i]=static_cast<DOG_SLAM3::EdgeInverseSim3ProjectXYZ*>(NULL);
            nBad++;
