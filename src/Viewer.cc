...
void Viewer::Run()
{
    ...
    while(1)
    {
        ...
        // //保存图片 start
        // int fileNumber = mnId01;
        // std::string outputPath = "11/imResult_image-328-2/";
        // std::string extension = ".jpg";
        // // 创建文件名
        // std::ostringstream oss;
        // oss << outputPath << fileNumber << extension;
        // std::string filename = oss.str();
        // // std::string filename = "frame_" + std::to_string(frame_counter) + ".png"; // 确保每个文件名都是唯一的
